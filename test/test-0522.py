...
model_path = 'C:\\Users\\sypza\\RNN_Keepyourheeeeadup\\model\\keepheeead-model-0522.pkl'
try:
            ...
            if len(values) == 13:
                try:
                    ...
                    input_features = np.array([roll1, pitch1, roll2, pitch2, roll3, pitch3, 
                                               roll4, pitch4, roll5, pitch5, roll6, FSR]).reshape(1, -1)
                ...
                # 터미널에 출력
                print(t, roll1, pitch1, roll2, pitch2, roll3, pitch3, roll4, pitch4, roll5, roll6, FSR, predicted_class)
